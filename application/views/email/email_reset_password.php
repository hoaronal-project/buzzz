                        ...
                        <td style="text-align: center;">
                            <div style="height: 70px;width:100%;text-align: center;margin-bottom: 10px;">
                                <a href="<?php echo base_url(); ?>">
                                    <img src="<?php echo get_logo($general_settings); ?>" alt="" style="max-width: 180px;max-height: 70px;">
                                </a>
                            </div>
                        </td>
                    </tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="mailcontent" style="line-height: 26px;font-size: 14px;">
                                            ...
                                            <p style='text-align: center;margin-top: 30px;'>
                                                <a href="<?php echo lang_base_url(); ?>reset-password?token=<?php echo $token; ?>" style='font-size: 14px;text-decoration: none;padding: 14px 40px;background-color: #1abc9c;color: #ffffff !important; border-radius: 3px;'>
