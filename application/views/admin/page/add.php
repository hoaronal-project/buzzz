            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <select id="parent_links" name="parent_id" class="form-control" style="max-width: 600px;">
                            ...
                            <?php foreach ($menu_links as $item): ?>
                                <?php if ($item["type"] != "category" && $item["location"] == "main" && $item['parent_id'] == "0"): ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="page_order" placeholder="<?php echo trans('order'); ?>" value="1" min="1" max="3000" style="width: 300px;max-width: 100%;" <?php echo ($rtl == true) ? 'dir="rtl"' : ''; ?>>
                    </div>
