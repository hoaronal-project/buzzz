                                ...
                                <div class="row">
                                    <div class="col-sm-11">
                                        <p>
                                            ...
                                            <?php else: ?>
                                                <strong class="color-danger"><?php echo phpversion(); ?>&nbsp;<small>(Your PHP version must be version 5.6 or greater)</small></strong>
                                            <?php endif; ?>
                                        </p>
                                        <p>
                                            ...
                                            <?php else: ?>
                                                <strong class="color-danger">Disabled&nbsp;<small>(You should enable cURL)</small>
                                                </strong>
                                            <?php endif; ?>
                                        </p>
                                        <p>
                                            ...
                                            <?php if (extension_loaded('mbstring')): ?>
                                                <strong class="color-success">Enabled</strong>
                                            <?php else: ?>
                                                <strong class="color-danger">Disabled&nbsp;<small>(You should enable mbstring)</small></strong>
                                            <?php endif; ?>
                                        </p>
                                        <p>
                                            ...
                                            <?php if (extension_loaded('gd')): ?>
                                                <strong class="color-success">Enabled</strong>
                                            <?php else: ?>
                                                <strong class="color-danger">Disabled&nbsp;<small>(You should enable gd)</small>
                                                </strong>
                                            <?php endif; ?>
                                        </p>
