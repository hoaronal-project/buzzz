    ...
    <div class="footer-bottom">
      <div class="container">
        ...
        <!--<p class="pull-left">Copyright © 2018 <a href="{{ config('scart.homepage') }}">{{ config('scart.name') }} {{ config('scart.version') }}</a> Inc. All rights reserved.</p>-->
          ...
          <p class="pull-left">Copyright © 2018 <a href="https://devskill.org/">Devskill team</a> Inc. All rights reserved.</p>
          <p class="pull-right">Hosted by  <span><a target="_blank" href="https://devskill.org">Devskill</a></span></p>
        </div>
      </div>
    </div>
  </footer>
