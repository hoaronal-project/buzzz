    ...
    <div class="col-sm-12">
        ...
        <div class="row">
            <div class="col-sm-12 form-header">
                <h1 class="form-title"><?php echo trans('update_article'); ?></h1>
            ...
            <div class="col-sm-12">
                <div class="form-post">
                    <div class="form-post-left">
                        <?php $this->load->view("admin/includes/_form_update_post_left", ['show_content_field' => true]); ?>
                    </div>
                    <div class="form-post-right">
                        <div class="row">
                            ...
                            <?php if ($post->post_type == "post" || $post->post_type == "post"): ?>
                                <div class="col-sm-12">
                                    <div class="box">
                            ...
                            <div class="col-sm-12">
                                <?php $this->load->view('admin/includes/_post_publish_edit_box', ['post_type' => 'article']); ?>
                            </div>
                        </div>
                    </div>
                </div>
