            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control max-400" name="widget_order" min="1" max="3000" placeholder="<?php echo trans('order_1'); ?>" value="<?php echo html_escape($widget->widget_order); ?>" <?php echo ($rtl == true) ? 'dir="rtl"' : ''; ?> required>
                    </div>
