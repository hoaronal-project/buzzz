...
function update_config_database($db_host, $db_name, $db_user, $db_password)
{
    $config = array();
    include 'config/config.php';
...
function update_config_admin($timezone, $admin_username, $admin_email, $admin_password)
{
    $config = array();
    include 'config/config.php';
