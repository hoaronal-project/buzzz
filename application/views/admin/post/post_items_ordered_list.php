...
<div class="post-items-container">
    ...
    if (!empty($post_items)):
        foreach ($post_items as $post_item):?>
            <!-- form start -->
            <?php echo form_open_multipart('post_controller/update_ordered_list_item_post'); ?>
            <div class="box box-primary <?php echo ($post_item->is_collapsed == 1) ? 'collapsed-box' : ''; ?>">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        <button type="button" class="btn btn-box-tool" data-widget="collapse" onclick="set_ordered_list_item_box_collapsed(<?php echo $post_item->id; ?>);">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <textarea class="form-control ckeditor" id="editor_<?php echo $post_item->id; ?>" name="content"><?php echo $post_item->content; ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="box-footer text-right" style="padding-top: 0;">
                    <button type="button" class="btn btn-md btn-danger m-r-5" onclick="delete_ordered_list_item('<?php echo $post_item->id; ?>','<?php echo trans("confirm_item"); ?>');"><i class="fa fa-trash"></i>&nbsp;&nbsp;&nbsp;<?php echo trans("delete"); ?></button>
...
<?php echo form_open_multipart('post_controller/add_ordered_list_item_post'); ?>
