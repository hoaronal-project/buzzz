            ...
            <div class="box box-primary <?php echo ($post_item->is_collapsed == 1) ? 'collapsed-box' : ''; ?>">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        <button type="button" class="btn btn-box-tool" data-widget="collapse" onclick="set_gallery_item_box_collapsed(<?php echo $post_item->id; ?>);">
                            ...
                            <div class="form-group m0">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 m-t-15">
                                        ...
                                        <input type="number" class="form-control" name="item_order" min="1" placeholder="<?php echo trans('order_1'); ?>" value="<?php echo $post_item->item_order; ?>" <?php echo ($rtl == true) ? 'dir="rtl"' : ''; ?> required>
                                    </div>
                                </div>
