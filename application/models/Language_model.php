...
class Language_model extends CI_Model
{
    ...
    public function add_language_pages($lang_id)
    {
        ...
        $page = array(
            'lang_id' => $lang_id, 'title' => "Contact", 'slug' => "contact", 'description' => "Varient Contact Page", 'keywords' => "varient, contact, page", 'is_custom' => 0, 'page_content' => "", 'page_order' => 1, 'visibility' => 1, 'title_active' => 1, 'breadcrumb_active' => 1, 'right_column_active' => 0, 'need_auth' => 0, 'location' => "top", 'parent_id' => 0, 'page_type' => "page",
        );
        $this->db->insert('pages', $page);

        $page = array(
            'lang_id' => $lang_id, 'title' => "Terms & Conditions", 'slug' => "terms-conditions", 'description' => "Varient Terms Conditions Page", 'keywords' => "varient, terms, conditions", 'is_custom' => 0, 'page_content' => "", 'page_order' => 1, 'visibility' => 1, 'title_active' => 1, 'breadcrumb_active' => 1, 'right_column_active' => 0, 'need_auth' => 0, 'location' => "footer", 'parent_id' => 0, 'page_type' => "page",
        );
        $this->db->insert('pages', $page);
    }
