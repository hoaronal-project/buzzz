    ...
    <div class="col-sm-12">
        ...
        <div class="item-table-filter">
            ...
            <select name="post_type" class="form-control">
                <option value=""><?php echo trans("all"); ?></option>
                <option value="post" <?php echo ($this->input->get('post_type', true) == 'post') ? 'selected' : ''; ?>><?php echo trans("article"); ?></option>
                <option value="ordered_list" <?php echo ($this->input->get('post_type', true) == 'ordered_list') ? 'selected' : ''; ?>><?php echo trans("ordered_list"); ?></option>
                <option value="gallery_post" <?php echo ($this->input->get('post_type', true) == 'gallery') ? 'selected' : ''; ?>><?php echo trans("gallery"); ?></option>
        ...
        <div class="item-table-filter">
            ...
            <select id="categories" name="category" class="form-control" onchange="get_sub_categories(this.value);">
                ...
                <?php if (!empty($this->input->get('lang_id', true))) {
                    $categories = $this->category_model->get_top_categories_by_lang($this->input->get('lang_id', true));
                } else {
                    $categories = $this->category_model->get_all_top_categories();
                } ?>
