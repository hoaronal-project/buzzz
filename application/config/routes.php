...
$route['rss/author/(:any)'] = 'home_controller/rss_by_user/$1';
...
$route["cron/check-scheduled-posts"] = 'cron_controller/check_scheduled_posts';

$route['(:any)/(:num)'] = 'home_controller/gallery_post/$1/$2';
/*
*-------------------------------------------------------------------------------------------------
* ADMIN ROUTES
*-------------------------------------------------------------------------------------------------
...
$route[$r_admin . "/add-gallery"] = 'post_controller/add_gallery';
$route[$r_admin . "/gallery-post-items/(:num)"] = 'post_controller/gallery_post_items/$1';
$route[$r_admin . "/add-ordered-list"] = 'post_controller/add_ordered_list';
$route[$r_admin . "/ordered-list-items/(:num)"] = 'post_controller/ordered_list_items/$1';
...
$route[$r_admin . "/send-email-subscriber/(:num)"] = 'admin_controller/send_email_subscriber/$1';
...
foreach ($languages as $language) {
    if ($language->status == 1 && $general_settings->site_lang != $language->id) {
        ...
        $route[$key . '/rss/author/(:any)'] = 'home_controller/rss_by_user/$1';
