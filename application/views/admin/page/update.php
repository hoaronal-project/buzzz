    ...
    <div class="col-sm-12 col-xs-12">
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <?php if ($page->is_custom == 1 && ($page->slug != 'terms-conditions')): ?>
                    <div class="form-group">
                ...
                <?php if ($page->location != "none"): ?>
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="page_order" placeholder="<?php echo trans('order'); ?>" value="<?php echo $page->page_order; ?>" min="1" max="3000" style="width: 300px;max-width: 100%;" <?php echo ($rtl == true) ? 'dir="rtl"' : ''; ?>>
                    </div>
                <?php else: ?>
